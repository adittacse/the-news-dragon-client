        ...
        children: [
            {
                ...
                loader: ({params}) => fetch(`https://the-news-dragon-server-adittacse.vercel.app/categories/${params.id}`)
            }
        ]
    },
    {
        ...
        children: [
            {
                ...
                loader: ({params}) => fetch(`https://the-news-dragon-server-adittacse.vercel.app/news/${params.id}`)
            }
        ]
    }
]);
